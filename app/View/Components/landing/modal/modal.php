...
class modal extends Component
{
    ...
    public function contentModal()
    {
        return 'De conformidad con lo dispuesto en la Ley Federal de Protección de Datos Personales en Posesión de los Particulares y a los requisitos que dicha legislación establece, HELLO MÉXICO: Agencia de contenidos digitales S.A. de C.V, da a conocer el presente documento:
            Para efectos del presente Aviso de Privacidad, se entenderá por:
            Aviso de Privacidad: Se refiere al presente documento, el cual es puesto a disposición del TITULAR, previo al tratamiento de sus datos personales, de conformidad con el artículo 15 de la Ley Federal de Protección de Datos Personales en Posesión de los Particulares.
            ...
            Derechos: Se refiere a los derechos de acceso, cancelación, rectificación y oposición con los que cuenta el TITULAR en relación a sus datos personales.
            Encargado: La persona física o moral que sola o conjuntamente con otras trate datos personales por cuenta del responsable.
            Ley:  Ley Federal de Protección de Datos Personales en Posesión de los Particulares y/o su  Reglamento.
            Responsable: Hello México, Agencia de Contenidos Digitales S.A. de C.V,  en su carácter de persona moral privada que decide sobre el tratamiento de datos personales.
            ...
            Compañía.
            Dirección.
            Información de contacto, incluyendo teléfono, correo electrónico y otros.
            Profesión y contacto laboral
            Cuando se requiera cédula profesional
            Identificación oficial con fotografía y vigente,
            Además de diversos Datos que se requieran y por ley se permitan recabar.
            La lista anterior debe entenderse como enunciativa, más no limitativa de aquellos datos de carácter personal que serán tratados por Hello México, Agencia de contenidos digitales S.A. de C.V, en el entendido que se trata de datos personales de la misma naturaleza.

            3) Hello México, Agencia de contenidos digitales S.A. de C.V,  hace de su conocimiento que los datos personales del titular serán tratados por Hello México,  Agencia de contenidos digitales S.A. de C.V,   y/o las empresas afiliadas de la misma, encargadas que actúen en nombre de Hello México,  Agencia de contenidos digitales S.A. de C.V,   y terceros, distintos a Hello México, Agencia de contenidos digitales S.A. de C.V,   o al titular de los datos, quienes deberán cumplir con el presente Aviso de Privacidad.

            4) Las finalidades del tratamiento de los datos personales del TITULAR por parte de Hello México, Agencia de contenidos digitales S.A. de C.V, son las que se enuncian a continuación, así como todas aquellas que resulten análogas:
            Envío de publicidad informativa relativa a temas del servicio proporcionado.
            Fines informativos, administrativos y/o comerciales relacionados con el servicio proporcionado.

            5) Al acceder al presente sitio y aceptar el presente Aviso de Privacidad, usted en su carácter de TITULAR otorga expresamente a Hello México, Agencia de contenidos digitales S.A. de C.V,   su consentimiento para la transferencia nacional e internacional de sus datos personales, siempre que el receptor de los datos asuma las mismas obligaciones asumidas por Hello México, Agencia de contenidos digitales S.A. de C.V.
            Asimismo, Hello México, Agencia de contenidos digitales S.A. de C.V, se compromete a transferir solo aquella información que sea necesaria para la misma finalidad con la que se emite el presente aviso.
            ...
            El TITULAR tendrá derecho en todo momento y por causa legítima a oponerse al tratamiento de sus datos. De resultar procedente la solicitud, Hello México,  Agencia de contenidos digitales S.A. de C.V, no podrá tratar los datos del TITULAR.
