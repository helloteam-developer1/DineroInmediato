...
<html lang="en">
  <head>
    ...
    <title>Modal Crédito vencido impago</title>
    <style>
    @font-face {
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
    Abrir Estatus de crédito - Crédito vencido impago
  </button>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body ms-4 me-4">
          <p class="texto-carotSans--Medium" style="font-size: 30px; color: #F5A733;">Crédito vencido impago</p>
          <p class="texto-carotSans--Regular" style="font-size: 20px; color: #474747;">Usted ha caído en impago. Por favor, póngase al corriente con su crédito lo
            ...
            cobranza en la sección “mensajes”.</p>
        </div>
