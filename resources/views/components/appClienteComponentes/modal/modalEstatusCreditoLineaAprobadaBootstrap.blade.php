...
<html lang="en">
  <head>
    ...
    <title>Modal Línea de credito aprobada</title>
    <style>
    @font-face {
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
    Abrir Estatus de crédito - Línea de crédito aprobada
  </button>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body ms-4 me-4">
          <p class="texto-carotSans--Medium" style="font-size: 30px; color: #F5A733;">Línea de crédito aprobada</p>
          <p class="texto-carotSans--Regular" style="font-size: 20px; color: #474747;">“Felicidades, tu línea de crédito fue aprobada”
            , haz clic en el botón para comenzar.</p>
        </div>
          ...
          <div class="container-fluid h-100"> 
    		    <div class="row w-100 align-items-center">
    			    <div class="col text-center">
    				    ...
    				    <button class="btn regular-button texto-carotSans--Medium" style="background-color:  #F5A733; color: #FFFFFF;">Obtener crédito</button>
              </div>	
    		    </div>
    	    </div>
          <!-- <center>
