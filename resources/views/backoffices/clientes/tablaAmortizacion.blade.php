                    ...
                    <div class="col-12 col-sm-12 col-md-10 col-lg-10 offset-md-1 offset-lg-1">
                      <div class="table-responsive text-center">
                        <table class="table table-bordered border-secondary table-light table-striped" id="tabla-amortizacion">
                          <thead>
                            <tr>
                              <th scope="col" class="px-5">Num de cre</th>
                              <th scope="col" class="px-5">de pago </th>
                              <th scope="col" class="px-5">Próximo pago</th>
                              <th scope="col" class="px-5">Pago a capital</th>
                              <th scope="col" class="px-5">Interés ordinarios</th>
                              <th scope="col" class="px-5">IVA interés ordinario</th>
                              <th scope="col" class="px-5">Comisiones</th>
                              <th scope="col" class="px-5">Pago total mensual</th>
                              <th scope="col" class="px-5">Agregar fila</th>
                              <th scope="col" class="px-5">Editar</th>
                              <th scope="col" class="px-5">Eliminar fila</th>
                            </tr>
                          </thead>
                          <tbody>
                              <tr>
