<div>
    ...
    <div class="row empresa">
        <input type="password" id="password" class="form-control empresa" placeholder="* Nueva Contraseña" wire:model.defer="password" name="password" maxlength="50" required>
        
        <input type="password" id="password2"class="form-control" style="margin-top:20px;"placeholder="* Confirmación de contraseña" wire:model.defer="password_confirmation" name="password_confirmation" maxlength="50" required>
