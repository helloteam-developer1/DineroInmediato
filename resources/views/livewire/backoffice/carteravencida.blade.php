<div>
    <button class="btn boton-color px-4 mx-4" data-bs-toggle="modal" data-bs-target="#carteraVencida{{$user}}">
        Enviar
    </button>
    <!--Inicio de modal enviar a  cartera vencida -->
    <div class="modal fade" wire:ignore.self id="carteraVencida{{$user}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-10 col-lg-10 offset-md-1 offset-lg-1">
                                        ...
                                        <button type="button" class="btn px-4 my-2"
                                            style="background-color: #f29100; color:white; float:right;" wire:click="cartera({{$user}})" wire:loading.class="disabled">Aceptar</button>
                                    </div>
                                    @error('cartera')
                                        <div class="row">
                                            <div class="col-12 col-sm-12 col-md-10 col-lg-10 offset-md-1 offset-lg-1">
