                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-10 offset-md-3 offset-lg-1">
                                        <p class="text-secondary" style="font-size: 18px;">¿Estás seguro de eliminar el
                                            registro?</p>
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-10 col-lg-10 offset-md-1 offset-lg-1">
                                        ...
                                        <button type="button" class="btn px-4 my-2"
                                            style="background-color: #f29100; color:white; float:right;"
                                            wire:click="eliminar({{ $re }})"
                                            wire:loading.class="disabled">Aceptar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
