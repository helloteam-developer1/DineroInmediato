<div class="row-span-1 col-span-1 text-center calculadoraItems  mt-4">
    <span class="texto-solicita-negro cuantoNecestas">¿Cu&aacute;nto <strong class="text-green">dinero</strong> necesitas?</span>
</div>

<div class="row-span-1 col-span-1  calculadoraItems  marginTop">
    <h3 style=" "><strong class="texto-gris textCalcualdora">Pr&eacute;stamo</strong></h3>
</div>

<div class="crow-span-1 col-span-1 calculadoraItems  marginTop marginBottom">
    <livewire:landing.slider-prestamo/>
</div>

<div class="row-span-1 col-span-1 self-center textCalcualdora calculadoraItems  mt-3 marginTop">
...
<div class="row-span-1 col-span-1 text-center  calculadoraItems btnSiguenteMovil ">
    <button class="btn btn-verde " id="btnSig" style="font-size: 28px"><strong>Siguiente</strong></button>
</div>
