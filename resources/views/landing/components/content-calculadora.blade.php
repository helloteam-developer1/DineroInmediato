<div class="row-span-1 col-span-1 text-center calculadoraItems cuantoNecestas">
...
<div class="row-span-1 col-span-1 text-center  calculadoraItems btnSiguenteMovil ">
        <button class="btn btn-verde mt-10" id="btnSig" style="font-size: 32px"><strong>Siguiente</strong></button>
</div>
